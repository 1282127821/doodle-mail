...
@AutoConfiguration
@ConditionalOnClass(MailVaadinProperties.class)
@EnableConfigurationProperties(MailVaadinProperties.class)
@EnableVaadin(MailVaadinProperties.PREFIX_VIEWS)
public class MailVaadinAutoConfiguration {
